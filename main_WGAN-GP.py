...
generator_class = 0
wgan_gp = WGAN_GP(gen_optim, disc_optim, noise_dim=100, dropout=0.3, input_dim=x_train.shape[2])
x_train_class_0 = x_train[y_train[:,generator_class]==1,:]
loss_history_class_0 = wgan_gp.train(x_train_class_0, epochs=100)
print("Class 0 fake samples are generating")
generator_class_0 = wgan_gp.generator
generated_samples_class_0, _ = wgan_gp.generate_fake_data(N=len(x_train_class_0))

# generate samples for class 1
generator_class = 1
wgan_gp = WGAN_GP(gen_optim, disc_optim, noise_dim=100, dropout=0.3, input_dim=x_train.shape[2])
x_train_class_1 = x_train[y_train[:,generator_class]==1,:]
loss_history_class_1  = wgan_gp.train(x_train_class_1, epochs=100)
print("Class 1 fake samples are generating")
generator_class_1 = wgan_gp.generator
generated_samples_class_1, _ = wgan_gp.generate_fake_data(N=len(x_train_class_1))

# generate samples for class 2
generator_class = 2
wgan_gp = WGAN_GP(gen_optim, disc_optim, noise_dim=100, dropout=0.3, input_dim=x_train.shape[2])
x_train_class_2 = x_train[y_train[:,generator_class]==1,:]
loss_history_class_2 = wgan_gp.train(x_train_class_2,epochs=100)
print("Class 2 fake samples are generating")
generator_class_2 = wgan_gp.generator
generated_samples_class_2, _ = wgan_gp.generate_fake_data(N=len(x_train_class_2))
